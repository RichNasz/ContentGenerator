...
/// Coordinates state for the project agent generation window.
///
...
/// `openWindow(id: "project-agent-generation")` is called.
@Observable
public class AgentGenerationWindowState {
    ...
    ///
    /// Call this before invoking `openWindow(id: "project-agent-generation")`.
