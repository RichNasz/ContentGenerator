...
> **Note:** This project is not currently accepting external contributions. It is being individually driven at this time. When contributions open in the future, the process described in this document will apply.

Thank you for your interest in ContentGenerator. This project uses a spec-driven development workflow where specifications are the source of truth for all code changes.

## Code of Conduct

This project follows the [Contributor Covenant v2.1](CODE_OF_CONDUCT.md). All participants are expected to uphold it. Unacceptable behavior can be reported via GitHub's private vulnerability reporting on this repository.
...
Open a bug report using the [bug report issue template](.github/ISSUE_TEMPLATE/bug_report.md). Provide your macOS version, Xcode version, and steps to reproduce.

## How to Suggest Features

Open a feature request using the [feature request issue template](.github/ISSUE_TEMPLATE/feature_request.md). Describe the problem or use case, your proposed solution, and any alternatives you have considered.
